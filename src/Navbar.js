    ...
    <nav className="nav">
      <header className="nav-header">
        <div className="nav-brand">
          <img src='https://raw.githubusercontent.com/omardeangelis/react-tutorial-base/06973ab64aa310d7dd2ff8c8496dbc09ecc33aa7/navbar/risultato/src/logo.svg' alt="logo" className="nav-logo" />
          <h4>DevBar</h4>
        </div>
